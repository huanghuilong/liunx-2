...
#include <memory>
#include "../../../../../src/client/include/CreateGroupDialog.h"
...
QT_MOC_LITERAL(1, 18, 22), // "groupCreationRequested"
QT_MOC_LITERAL(2, 41, 0), // ""
QT_MOC_LITERAL(3, 42, 4), // "name"
QT_MOC_LITERAL(4, 47, 4) // "desc"

    },
    "CreateGroupDialog\0groupCreationRequested\0"
    "\0name\0desc"
};
...
void CreateGroupDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->groupCreationRequested((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CreateGroupDialog::*)(const QString & , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CreateGroupDialog::groupCreationRequested)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CreateGroupDialog::groupCreationRequested(const QString & _t1, const QString & _t2)
{
